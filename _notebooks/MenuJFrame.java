...
public class MenuJFrame extends JFrame implements ActionListener {
    ...
    public MenuJFrame(String title) {
        ...
        System.out.println("Ran Java 1");
        frame = new JFrame(title);
        System.out.println("Ran Java 2");
	    menubar = new JMenuBar();
        System.out.println("Ran Java 3");
	    menu = new JMenu("Menu");
        System.out.println("Ran Java 4");
        ...
        System.out.println("Ran Java 5");

        // Adding / Connecting Objects
        menubar.add(menu);
        frame.setJMenuBar(menubar);
        frame.add(message);
        System.out.println("Ran Java 6");
